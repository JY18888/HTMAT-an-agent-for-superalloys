...
def rewrite_query_to_symbols(query):
    ...
    rewritten = call_deepseek(messages, max_tokens=120)
...
def main():
    ...
    with open(output_file, 'w', newline='', encoding='utf-8') as f:
        ...
        writer.writerow([
            ...
            "Pure_DeepSeek", "Pure_RAG", "DeepSeek+RAG_Enhanced"
        ])
    ...
    for i, item in enumerate(TEST_QA, start=1):
        ...
        ans1 = pure_deepseek(q)
        time.sleep(0.5)
        ans2 = pure_rag(q)
        time.sleep(0.5)
        ans3 = deepseek_plus_rag(q)
        time.sleep(1)
    ...
    print("\n🔍 重点关注：")
    print("- ID 41~60：DeepSeek+RAG_Enhanced 应显著优于 Pure_RAG")
